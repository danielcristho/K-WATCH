...
EXCLUDED_NAMESPACES  = set(os.getenv("EXCLUDED_NAMESPACES", "kube-system,wazuh,k-watch,local-path-storage").split(","))
BENIGN_POD_PATTERNS  = set(os.getenv("BENIGN_POD_PATTERNS", "app-server").split(","))
NODE_NAME            = os.getenv("NODE_NAME", "")
MIN_SYSCALL_THRESHOLD = int(os.getenv("MIN_SYSCALL_THRESHOLD", "20"))
MIN_FLOW_THRESHOLD    = int(os.getenv("MIN_FLOW_THRESHOLD", "5"))
